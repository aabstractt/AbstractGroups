...
import dev.thatsmybaby.shared.commands.group.CreateGroupArgument;
...
public final class CoreAdminCommand {
    ...
    public CoreAdminCommand() {
        this.addArgument(
                new CreateGroupArgument("creategroup", "Create a new group", "abstractgroups.command.creategroup", null),
